    ...
    return (
        <>
            <div className="content">
                ...
                <div className="disclaimer">Trading is risky! 0xSwap is not responsible for any trading losses or financial losses while using the app. DYOR before buying any token or making any trade to avoid getting rekt. 0xSwap is beta software and may contain bugs. Contribution to the repo is appreciated. Credits 0xThug</div>
            </div>
            <style jsx>{`
                .content {
                    width: 100%;
